...
void Controller::QueryPointerBufferSize(HLERequestContext& ctx) {
    ...
    // [Nextendo] The previous computed formula here (descriptor-size accounting rounded up to a
    ...
    // (matching Ryujinx-Nextendo's own finding: an NPLN gRPC client's presence/friends/catalog/
    ...
    // 0xF000 matches Ryujinx-Nextendo's own fix for exactly this (515040a) -- the maximum a 16-bit
