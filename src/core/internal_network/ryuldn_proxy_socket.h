...
class RyuLdnProxySocket : public SocketBase {
public:
    explicit RyuLdnProxySocket(RyuLdn::RyuLdnClient& client_) noexcept;
    ~RyuLdnProxySocket() override;
